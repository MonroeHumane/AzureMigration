// ═══════════════════════════════════════════════════════════════
//  SHELTER TYCOON - Visitor NPC (adopters, walk-ins)
// ═══════════════════════════════════════════════════════════════
...
export class Visitor {
  constructor(type, targetRoomType) {
    ...
    this.type = type; // 'adopter' | 'client' | 'candidate' | 'walkin' | 'customer'
      ...
      case 'walking_to_door':
        ...
        if (this.path.length === 0 || this.pathIdx >= this.path.length) {
          if (!this.targetRoom) {
            ...
            this.requestedRole = (this.type === 'adopter' || this.type === 'client') ? null
              : this.type === 'candidate' ? 'meeting' : this.type === 'customer' ? 'lobby' : null;
            break;
          }
