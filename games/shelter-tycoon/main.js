...
import { initEngine, setClickHandler, setBuildDragCallbacks, smoothZoom, toScreen, toTile, getZoom, focusCameraOnTile } from './engine.js';
...
function applySavedState(saved) {
  ...
  if (saved.adoptedPetIds) G.adoptedPetIds = [...saved.adoptedPetIds];
