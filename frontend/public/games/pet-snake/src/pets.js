// Pet Snake Adventure — Real Shelter Pet Integration
// Fetches real adoptable dogs & cats from Monroe Humane for rescue objectives.
...
function normalize(raw) {
  ...
  return {
    id: String(raw.id || ''),
    name: raw.name || 'Adoptable companion',
...
export function drawForRun(count = 10) {
