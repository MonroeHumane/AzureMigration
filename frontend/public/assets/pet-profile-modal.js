...
(function () {
  ...
  function ensureModal() {
    ...
    dialog.innerHTML =
      ...
      '    <div class="monroe-pet-profile-modal__actions">' +
      '      <a class="monroe-pet-profile-modal__external" href="#" target="_blank" rel="noopener noreferrer" title="Open in new window">' +
    ...
    var externalLink = dialog.querySelector('.monroe-pet-profile-modal__external');
  ...
  function open(url, name) {
    ...
    var extLink = dialog.querySelector('.monroe-pet-profile-modal__external');
    if (extLink) {
      if (profileUrl) {
        extLink.href = profileUrl;
