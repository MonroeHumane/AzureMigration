    ...
    function renderRuntimeAnimalCards(animals) {
      ...
      animals.forEach(function (a) {
        ...
        if (a.featured || a.is_new) {
          ...
          badge.className =
            'monroe-pet-badge' + (a.featured ? '' : ' monroe-pet-badge--available');
        ...
        addChip(chips, a.species_label || capitalize(a.type));
        addChip(chips, capitalize(a.gender));
        ...
        viewHint.className = 'animal-view-profile';
        viewHint.textContent = i18n.viewProfile || 'View profile';
